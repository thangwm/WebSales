...
namespace WebSales.Areas.Admin.Controllers
{
    public class SystemSettingController : Controller
    {
        ...
        public ActionResult Partial_SystemSetting()
        {
            return PartialView();
        }

        [HttpPost]
        public ActionResult Add(SystemSettingViewModel req)
        {
            ...
            return View("Partial_SystemSetting");
        }
    }
}